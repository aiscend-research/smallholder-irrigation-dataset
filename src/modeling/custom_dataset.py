...
class MultiTemporalCropDataset(Dataset):
    def __init__(self, image_dir, label_dir, sample_file_list, label_bands=[482]):
        """
        Args:
            ...
            label_bands (list of int): List of band indices from label .tif to use as target(s).
        """
    ...
    def plot_image_band_timeseries(image_tensor, band_idx=7, num_steps=5):
        ...
        Args:
            image_tensor (Tensor): shape (13, 37, H, W)
            band_idx (int): Spectral band index (0–12)
