"""
Visualization functions for Google Earth Pro screenshots with polygon overlays.

This module provides functions to:
1. Load GEP screenshots from the data/labels/GEP_screenshots directory
...
# Directory containing GEP (Google Earth Pro) screenshots
def get_screenshot_dir():
    return os.path.join(_get_project_root(), 'data/labels/GEP_screenshots')
...
def parse_screenshot_filename(filename):
    """
    Parse a GEP screenshot filename to extract survey, internal_id, and date.
...
def list_available_screenshots():
    """
    List all available GEP screenshots.
...
def plot_screenshot_with_polygons(screenshot_path=None, survey=None, internal_id=None,
    ...
    """
    Plot a GEP screenshot with polygon overlays from all labelers.
...
def plot_random_screenshot(ax=None, figsize=(10, 10), **kwargs):
    """
    Plot a random available GEP screenshot with polygon overlays.
    ...
    if len(screenshots) == 0:
        raise ValueError("No screenshots available in GEP_screenshots directory")
