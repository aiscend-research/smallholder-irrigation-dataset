'''
create_label_band_legacy.py

DEPRECATED: This is the legacy version of create_label_band.py.
Use create_label_band.py instead, which has:
- 9 bands (including polygon coverage %)
- Separate label files per labeler
- Proper coordinate transformation from EPSG:4326
- Support for versioned feature downloads
